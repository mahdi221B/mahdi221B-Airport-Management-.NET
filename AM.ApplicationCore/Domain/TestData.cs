...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
        ...
        // Staffs
        public static Staff captain = new Staff { FirstName = "captain", LastName = "captain", EmailAdress = "captain.captain@gmail.com", BirthDate = new DateTime(1965, 01, 01), EmployementDateTime = new DateTime(1999, 01, 01), Salary = 99999 };
        public static Staff hostess1 = new Staff { FirstName = "hostess1", LastName = "hostess1", EmailAdress = "hostess1.hostess1@gmail.com", BirthDate = new DateTime(1995, 01, 01), EmployementDateTime = new DateTime(2020, 01, 01), Salary = 999 };
        public static Staff hostess2 = new Staff { FirstName = "hostess2", LastName = "hostess2", EmailAdress = "hostess2.hostess2@gmail.com", BirthDate = new DateTime(1996, 01, 01), EmployementDateTime = new DateTime(2020, 01, 01), Salary = 999 };
        // Travellers
